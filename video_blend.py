...
if os_str == 'Windows':
    ...
    # ebsynth_bin = "D:\\Applications\\Ebsynth\\22EbSynth-Beta-Win\\ebsynth.exe"
elif os_str == 'Linux':
    ...
    for is_forward in [True, False]:
        ...
        for j in range(interval):
            ...
            if j == 0:
                ...
                # print_cmd = cmd.replace('-', '\n-')
                # print(print_cmd)
                # print()

                """
                .\deps\ebsynth\bin\ebsynth.exe
                -style D:\Files\PythonProjects\Rerender_A_Video\videos\woman\keys\0001.png
                -guide D:\Files\PythonProjects\Rerender_A_Video\videos\woman\video\0001.png D:\Files\PythonProjects\Rerender_A_Video\videos\woman\video\0002.png
                -weight 6
                -guide D:\Files\PythonProjects\Rerender_A_Video\videos\woman\tmp\out_1\edge_0001.jpg D:\Files\PythonProjects\Rerender_A_Video\videos\woman\tmp\out_1\edge_0002.jpg
                -weight 0.5
                -guide D:\Files\PythonProjects\Rerender_A_Video\videos\woman\tmp\out_1\temporal_0001.jpg D:\Files\PythonProjects\Rerender_A_Video\videos\woman\tmp\out_1\temporal_0002.jpg
                -weight 0.5
                -guide D:\Files\PythonProjects\Rerender_A_Video\videos\woman\tmp\out_1\pos_0001.jpg D:\Files\PythonProjects\Rerender_A_Video\videos\woman\tmp\out_1\pos_0002.jpg
                -weight 2
                -output D:\Files\PythonProjects\Rerender_A_Video\videos\woman\out_1\0002.jpg
                -searchvoteiters 12
                -patchmatchiters 6
                """
...
def run_ebsynth_slow(video_sequence: VideoSequence):
    beg = time.time()

    n_process = min(MAX_PROCESS, video_sequence.n_seq)
    mp.set_start_method('spawn')

    for i in range(0, video_sequence.n_seq, n_process):
        processes = []
        i_arr = list(range(i, i + 1))
        p = mp.Process(target=process_sequences, args=(i_arr, video_sequence))
        p.start()
        processes.append(p)
        for p in processes:
