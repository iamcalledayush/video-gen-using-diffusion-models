...
def process2(*args):
    ...
    key_frame_indexes = key_frame_sampler.extract_key_frames(cfg.input_dir, "optical", cfg.interval,
                                                             cfg.frame_count)
...
def process3(*args):
    ...
    # ============= not uniform
    cmd = (f'python video_blend_not_uniform.py {video_base_dir} --beg 1 --end {end_frame} '
